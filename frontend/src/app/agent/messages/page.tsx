...
const AgentMessagesPage = () => {
  ...
  const sendMessage = useCallback(async (content: string, type: 'text' | 'image' | 'voice' | 'file' = 'text', metadata?: any) => {
  ...
  return (
    <AgentLayout>
      <div className="h-screen bg-gray-50 dark:bg-dark-bg flex">
        {/* Conversations Sidebar */}
        <div className="w-full lg:w-80 bg-white dark:bg-dark-surface border-r border-gray-200 dark:border-gray-700 flex flex-col">
          {/* Header */}
        ...
        {selectedConversation ? (
          <div className="flex-1 flex flex-col">
            ...
            {/* Message Input */}
            <div className="bg-white dark:bg-dark-surface border-t border-gray-200 dark:border-gray-700 p-4">
              <div className="flex items-end space-x-3">
                ...
                <button
                  ...
                  className={`p-2 ${isRecording ? 'text-red-500' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}
                >
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    rows={1}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-dark-bg text-gray-900 dark:text-white focus:ring-2 focus:ring-agent-DEFAULT focus:border-agent-DEFAULT resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="p-2 bg-agent-DEFAULT text-white rounded-lg hover:bg-agent-DEFAULT/90 disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <div className="flex items-center space-x-2 mt-2">
                <button
                  ...
                  className="text-xs text-gray-500 dark:text-gray-400 hover:text-agent-DEFAULT"
                >
                  📍 Share Location
                </button>
                <button
                  onClick={() => sendMessage('⚠️ Issue Report: Quality concerns identified', 'text')} // Changed from 'report' to 'text'
