    ...
    <AgentLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
        ...
        {assignments.length > 0 && currentLocation && (
          <div className="fixed bottom-20 left-4 right-4 lg:left-68 bg-white dark:bg-dark-surface rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4">
