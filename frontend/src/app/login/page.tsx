...
// Redirect page that automatically triggers direct Asgardeo authentication
export default function LoginRedirectPage() {
  const { login, isAuthenticated, getUserDashboardRoute } = useAuth();
  ...
  useEffect(() => {
    // Automatically trigger login when this page loads
