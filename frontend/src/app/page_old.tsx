    ...
    <main className="flex min-h-screen flex-col overflow-hidden">
      ...
      <section className="py-20 bg-white dark:bg-dark-bg">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-primary dark:text-primary-light">
              Join Your Role in the Circular Economy
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Choose your path and start making an impact today. Each role plays a vital part in creating a sustainable future.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group relative">
              <div className="p-8 bg-gradient-to-br from-supplier/5 to-supplier/10 dark:from-supplier/10 dark:to-supplier/20 rounded-2xl border border-supplier/20 hover:border-supplier/40 transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2">
                <div className="text-center space-y-6">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto rounded-2xl bg-supplier/10 text-supplier group-hover:bg-supplier group-hover:text-white transition-all duration-300">
                    <Recycle className="w-10 h-10" />
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-secondary dark:text-secondary-light">Suppliers</h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Transform your recyclable materials into revenue streams through our smart marketplace.
                    </p>
                  ...
                  <Link href="/auth/register?role=supplier">
                    <Button variant="supplier" className="w-full group-hover:shadow-lg">
            ...
            {/* Buyers */}
            <div className="group relative">
              <div className="p-8 bg-gradient-to-br from-buyer/5 to-buyer/10 dark:from-buyer/10 dark:to-buyer/20 rounded-2xl border border-buyer/20 hover:border-buyer/40 transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2">
                <div className="text-center space-y-6">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto rounded-2xl bg-buyer/10 text-buyer group-hover:bg-buyer group-hover:text-white transition-all duration-300">
                    <Users className="w-10 h-10" />
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-secondary dark:text-secondary-light">Buyers</h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Access verified, high-quality recyclable materials through competitive auctions.
                    </p>
                    <ul className="text-sm text-gray-500 dark:text-gray-400 space-y-1">
                      <li>• Smart material recommendations</li>
                      <li>• Real-time auction participation</li>
                      <li>• Quality assurance guarantee</li>
                      <li>• Predictive demand analytics</li>
                    </ul>
                  </div>
                  <Link href="/auth/register?role=buyer">
                    <Button variant="buyer" className="w-full group-hover:shadow-lg">
            ...
            {/* Field Agents */}
            <div className="group relative">
              <div className="p-8 bg-gradient-to-br from-agent/5 to-agent/10 dark:from-agent/10 dark:to-agent/20 rounded-2xl border border-agent/20 hover:border-agent/40 transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2">
                <div className="text-center space-y-6">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto rounded-2xl bg-agent/10 text-agent group-hover:bg-agent group-hover:text-white transition-all duration-300">
                    <ShieldCheck className="w-10 h-10" />
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-secondary dark:text-secondary-light">Field Agents</h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Earn by verifying material quality and ensuring marketplace integrity.
                    </p>
                    <ul className="text-sm text-gray-500 dark:text-gray-400 space-y-1">
                      <li>• AI-assisted verification tools</li>
                  ...
                  <Link href="/auth/register?role=agent">
                    <Button variant="agent" className="w-full group-hover:shadow-lg">
                      Become an Agent
                      <ArrowRight className="w-4 h-4 ml-2" />
                    </Button>
                  </Link>
            ...
            {/* Organizations */}
            <div className="group relative">
              <div className="p-8 bg-gradient-to-br from-admin/5 to-admin/10 dark:from-admin/10 dark:to-admin/20 rounded-2xl border border-admin/20 hover:border-admin/40 transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-2">
                <div className="text-center space-y-6">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto rounded-2xl bg-admin/10 text-admin group-hover:bg-admin group-hover:text-white transition-all duration-300">
                    <Globe className="w-10 h-10" />
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-2xl font-bold text-secondary dark:text-secondary-light">Organizations</h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Scale your circular economy operations with enterprise-grade features.
                    </p>
                    <ul className="text-sm text-gray-500 dark:text-gray-400 space-y-1">
                      <li>• Bulk material management</li>
                  ...
                  <Link href="/auth/register?role=organization">
                    <Button variant="admin" className="w-full group-hover:shadow-lg">
      ...
      {/* Statistics Section */}
      <section className="py-20 bg-gradient-to-br from-primary/5 via-supplier/5 to-buyer/5 dark:from-dark-surface dark:via-dark-bg dark:to-dark-surface">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-primary dark:text-primary-light">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center space-y-4">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-primary to-supplier bg-clip-text text-transparent">
                25K+
              </div>
              <div className="text-lg font-medium text-secondary dark:text-secondary-light">
                Materials Processed
              </div>
            ...
            <div className="text-center space-y-4">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-supplier to-buyer bg-clip-text text-transparent">
                5,200
              </div>
              <div className="text-lg font-medium text-secondary dark:text-secondary-light">
                Active Users
              ...
              <div className="text-sm text-gray-500 dark:text-gray-400">
                Suppliers, buyers & agents
              </div>
            </div>

            <div className="text-center space-y-4">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-buyer to-agent bg-clip-text text-transparent">
                $2.8M
              </div>
              <div className="text-lg font-medium text-secondary dark:text-secondary-light">
                Transaction Volume
            ...
            <div className="text-center space-y-4">
              <div className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-agent to-primary bg-clip-text text-transparent">
                94%
              </div>
              <div className="text-lg font-medium text-secondary dark:text-secondary-light">
                Satisfaction Rate
